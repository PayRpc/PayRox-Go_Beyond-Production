...
export interface DeterministicChunkFactory extends BaseContract {
  connect(runner?: ContractRunner | null): DeterministicChunkFactory;
  waitForDeployment(): Promise<this>;

  interface: DeterministicChunkFactoryInterface;
