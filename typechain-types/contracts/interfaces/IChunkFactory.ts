...
export interface IChunkFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IChunkFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IChunkFactory;
  waitForDeployment(): Promise<this>;

  interface: IChunkFactoryInterface;
