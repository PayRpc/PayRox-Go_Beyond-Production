"""
Simple PayRox Knowledge Sharer for Ollama
Clean text-based approach to share PayRox system knowledge
"""

def create_simple_knowledge_text():
    """Create clean knowledge text for Ollama"""
    return """
...
if __name__ == "__main__":
    knowledge = create_simple_knowledge_text()
    
    # Save to file for manual sharing
    with open("payrox_knowledge_simple.txt", "w", encoding="utf-8") as f:
        f.write(knowledge)
    
    print("PayRox knowledge saved to payrox_knowledge_simple.txt")
    print("You can now share this with Ollama manually:")
    print()
    print("ollama run llama3.1:latest")
    print("Then paste the knowledge text and ask questions about PayRox!")
